...
{
	public partial class ReporterFeedbackScreen : ContentPage
	{


		ObservableCollection<Report> _Reports;

		public ReporterFeedbackScreen ()
		{
			InitializeComponent ();
		...
		protected override void OnAppearing ()
		{
			...
			_Reports = ReportMgr.getInstance ().GetReportsWithFeedback (this.ReceivedReports);

			ListView lv = this.FindByName<ListView> ("list");

			lv.ItemsSource = Reports;
		}

		public void reloadData(object sender, ItemTappedEventArgs e){
			//intentionally empty	
		}
		...
		private void ViewReportDetailed(object sender, ItemTappedEventArgs e){
			...
			//Application.Current.MainPage.PushAscyn (edit);
